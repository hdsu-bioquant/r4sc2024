...
counts <- Read10X_h5(filename = "/home/carlos/Documents/r4sc2024/day2/data/atac_pbmc_1k_nextgem_filtered_peak_bc_matrix.h5")
#metadata <- read.csv(
...
#)
metadata <- read.csv(
  file = "/home/carlos/Documents/r4sc2024/day2/data/atac_pbmc_1k_nextgem_singlecell.csv",
  header = TRUE,
  row.names = 1
)
...
chrom_assay <- CreateChromatinAssay(
  counts = counts,
  sep = c(":", "-"),
  fragments = "/home/carlos/Documents/r4sc2024/day2/data/atac_pbmc_1k_nextgem_fragments.tsv.gz",
  min.cells = 10,
  min.features = 200
)
...
```{r,  subseting_reference, include=FALSE, eval=FALSE}
# Load the pre-processed scRNA-seq data for PBMCs
pbmc_rna <- readRDS("/home/carlos/Documents/r4sc2024/day2/data/pbmc_10k_v3.rds")
pbmc_rna <- UpdateSeuratObject(pbmc_rna)
pbmc_subset <- pbmc_rna[, sample(x = 1:ncol(pbmc_rna), 1000)]
saveRDS(pbmc_subset, file = "/home/carlos/Documents/r4sc2024/day2/data/pbmc_1k_v3.rds", compress = TRUE)
rm(pbmc_subset)
```
...
```{r, include=FALSE}
da_peaks %>% dplyr::filter(p_val_adj<0.05) %>% dim
```
